package farmacia.views.helloworld2;
...
import farmacia.data.entity.SamplePerson;
import farmacia.data.service.SamplePersonService;
...
@Route(value = "hello2")
@Uses(Icon.class)
public class HelloWorld2View extends Div {
    ...
    public HelloWorld2View(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("hello-world2-view");
